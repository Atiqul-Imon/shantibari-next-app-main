...
export default async function FounderDetail({ params }) {
  ...
  return (
    <>
      ...
      <div className="relative bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 min-h-screen">
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          >
            ...
            <span className="font-medium">Back to Founders</span>
          </Link>
            ...
            <div className="px-8 py-12">
              ...
              <nav className="mb-8 text-sm text-gray-500">
                <ol className="flex items-center space-x-2">
                  ...
                  <li>/</li>
                  <li><Link href="/#founders" className="hover:text-gray-900 transition-colors">Founder Members</Link></li>
                  <li>/</li>
                  <li className="text-gray-900 font-medium">{member.name}</li>
                </ol>
              </nav>

              {/* Description */}
              <div className="prose prose-lg max-w-none">
                <div className="bg-gradient-to-br from-gray-50 to-blue-50 rounded-xl p-8 border-l-4 border-blue-600">
              ...
              <div className="mt-12 text-center">
                <Link
                  href="/#founders"
                  className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold rounded-full hover:from-blue-700 hover:to-purple-700 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-105"
                >
