...
export default function EntrepreneurialSupportProgram() {
  return (
    <div className="font-sans bg-gray-50">
      {/* Hero Section */}
      <div
        className="h-[28rem] bg-cover bg-center flex items-center justify-center text-white bg-gray-50 text-5xl font-extrabold shadow-lg"
        style={{
          backgroundImage:
            "url('https://res.cloudinary.com/db5yniogx/image/upload/v1735340419/aboutuscloudinary_si2umb.jpg')",
        }}
      >
        <div className="bg-opacity-60 px-8 py-4 rounded-xl">
        ...
        <section>
          ...
          <div className="rounded-lg overflow-hidden shadow-lg">
            <img
              ...
              alt="Entrepreneurial Support Program"
        ...
        <section>
          ...
          <div className="rounded-lg overflow-hidden shadow-lg">
            <img
              ...
              alt="Madam Walker Display Corner"
              className="w-full object-cover transition-transform hover:scale-105 duration-300"
            />
          </div>
        </section>
